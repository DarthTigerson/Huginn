...
export function DisplayPage() {
  ...
  return (
    <div className="h-full overflow-auto p-6 bg-panel">
      ...
      <p className="text-sm text-fg-muted mb-8">Fonts, text size, and panel appearance.</p>

      <div className="max-w-xl space-y-6">
        {/* Font */}
        <section className="rounded-xl border border-border/60 p-4">
          <h2 className="text-xs font-semibold text-fg-muted uppercase tracking-wider mb-3">Font</h2>
        ...
        {/* Text Size */}
        <section className="rounded-xl border border-border/60 p-4">
          <h2 className="text-xs font-semibold text-fg-muted uppercase tracking-wider mb-3">Text Size</h2>
          <div className="flex items-center gap-3">
            ...
            <span className="tabular-nums text-sm text-fg w-8 text-center select-none">{fontSize}</span>
            <button
              type="button"
              onClick={increase}
