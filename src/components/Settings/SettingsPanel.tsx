...
import { DISPLAY_TAB_PATH, EDITOR_SETTINGS_TAB_PATH, GIT_SETTINGS_TAB_PATH, BROWSER_SETTINGS_TAB_PATH, MODELS_SETTINGS_TAB_PATH, GRAPHIFY_SETTINGS_TAB_PATH, TODO_SETTINGS_TAB_PATH, JIRA_SETTINGS_TAB_PATH } from './paths'
