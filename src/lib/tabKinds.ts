...
import { isSettingsTab, isGitLogTab, isGitGraphTab, isGitBranchDiffTab, isGraphifyGraphTab, isUsageGraphTab, isTodoBoardTab, isTodoNewTab, isTerminalTab, isBrowserTab } from '@/components/Settings/paths'
