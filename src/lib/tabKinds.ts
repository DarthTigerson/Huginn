...
import { isSettingsTab, isGitLogTab, isGitGraphTab, isGitBranchDiffTab, isGraphifyGraphTab, isUsageGraphTab, isTodoBoardTab, isTerminalTab, isBrowserTab } from '@/components/Settings/paths'
