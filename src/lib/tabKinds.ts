...
import { isSettingsTab, isGitLogTab, isGitGraphTab, isGitBranchDiffTab, isGraphifyGraphTab, isUsageGraphTab, isTerminalTab, isBrowserTab } from '@/components/Settings/paths'
