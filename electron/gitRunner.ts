...
export class GitRunner {
  ...
  registerHandlers(): void {
    ...
    ipcMain.handle('git:graph', (_e, cwd: string, offset?: number) => getGitGraph(cwd, offset))
    ...
    ipcMain.handle('git:branchDiff', (_e, cwd: string, source: string, target: string, offset?: number) => getGitBranchDiff(cwd, source, target, offset))
